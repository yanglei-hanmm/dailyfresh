...
urlpatterns = [
    # path('register/', views.register,name='register'), #注册及注册处理
    path('register/',RegisterView.as_view(),name='register'), #注册及注册处理
    path('active/<str:token>',ActiveView.as_view(),name='active'), #用户激活
    path('login/',LoginView.as_view(),name='login'), #用户激活
    path('logout/',LogoutView.as_view(),name='logout'), #用户激活
